...
**最終更新**: 2025年7月12日  
**バージョン**: 1.0（RecRadiko実装ベース）  
**対象API**: Radiko v2/v3 API（認証・ストリーミング・番組情報）

## 概要

本仕様書は、RecRadikoプロジェクトで実際に使用しているRadiko APIの詳細な仕様をまとめたものです。実際のAPI呼び出し結果と動作確認済みの実装を基に作成されています。
